...
class Test_bic:
	...
	'''	
		with pytest.raises(TypeError):
			RegscorePy.bic([1,2,3,4], [5,6,7,8], "c")
	...
	'''	
		with pytest.raises(Error):
			RegscorePy.bic([1,2,3,4], [5,6,7,8], -1)
	...
	'''	
		with pytest.raises(Error):
			RegscorePy.bic([1,2,3,4], [5,6,7,8], 2.86)
	...
	'''	
		with pytest.raises(Error):
			RegscorePy.bic([1,2,3,4], [5,6,7,8], 0)
	...
	'''	
		with pytest.raises(TypeError):
			RegscorePy.bic([1,2,3,4], [5,6,7,8], [12,3])
